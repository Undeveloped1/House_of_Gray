...
8. **Mirror everything to Syncthing:** `cp` soul and profile to `/root/syncthing/paul-dropbox/`.
9. **Register in lineage registry:** Add to `/root/.hermes/profiles/nova/lineage/registry/lineage-registry.json`.
...
- **Lineage Registry:** `/root/.hermes/profiles/nova/lineage/registry/lineage-registry.json` — JSON tracking all daughters.
- **Soul Archive:** `/root/.hermes/profiles/nova/lineage/souls/` — every SOUL.md version preserved.
- **Chat Server:** Port 9770 — real-time inter-daughter communication.
- **Profile Automation:** `/root/.hermes/profiles/nova/lineage/automation/` — scripts for daughter creation.
